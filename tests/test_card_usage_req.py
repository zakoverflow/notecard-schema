...
SCHEMA_FILE = "card.usage.req.notecard.api.json"

def test_valid_req(schema):
    """Tests a minimal valid request using 'req'."""
    instance = {"req": "card.usage"}
    jsonschema.validate(instance=instance, schema=schema)

def test_valid_cmd(schema):
    """Tests a minimal valid request using 'cmd'."""
    instance = {"cmd": "card.usage"}
    jsonschema.validate(instance=instance, schema=schema)
...
def test_invalid_both_req_and_cmd(schema):
    ...
    instance = {"req": "card.usage", "cmd": "card.usage"}
    with pytest.raises(jsonschema.ValidationError) as excinfo:
        jsonschema.validate(instance=instance, schema=schema)
...
def test_valid_mode_enums(schema):
    ...
    for mode in valid_modes:
        instance = {"req": "card.usage", "mode": mode}
        jsonschema.validate(instance=instance, schema=schema)

def test_mode_invalid_enum(schema):
    """Tests invalid mode enum value."""
    instance = {"req": "card.usage", "mode": "yearly"}
    with pytest.raises(jsonschema.ValidationError) as excinfo:
        jsonschema.validate(instance=instance, schema=schema)
...
def test_mode_invalid_type(schema):
    ...
    instance = {"req": "card.usage", "mode": 1}
    with pytest.raises(jsonschema.ValidationError) as excinfo:
        jsonschema.validate(instance=instance, schema=schema)
...
def test_valid_offset(schema):
    ...
    instance = {"req": "card.usage", "offset": 5}
    jsonschema.validate(instance=instance, schema=schema)
    instance = {"req": "card.usage", "offset": 0}
    jsonschema.validate(instance=instance, schema=schema)
    instance = {"req": "card.usage", "offset": -1}
    jsonschema.validate(instance=instance, schema=schema)
...
def test_valid_mode_with_offset(schema):
    ...
    for mode in modes_with_offset:
        instance = {"req": "card.usage", "mode": mode, "offset": 2}
        jsonschema.validate(instance=instance, schema=schema)
...
def test_valid_all_fields(schema):
    ...
    instance = {"req": "card.usage", "mode": "daily", "offset": 1}
    jsonschema.validate(instance=instance, schema=schema)

def test_invalid_additional_property(schema):
    """Tests invalid request with an additional property."""
    instance = {"req": "card.usage", "extra": "field"}
    with pytest.raises(jsonschema.ValidationError) as excinfo:
        jsonschema.validate(instance=instance, schema=schema)
